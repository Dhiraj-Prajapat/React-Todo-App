...
const Home = () => {
  ...
  return (
    <div className=" w-full relative min-h-screen pb-60 bg-gradient-to-tr from-blue-600 to-sky-400">
      <div className=" max-w-[1300px] px-3 m-auto">
        <div>
          ...
          {addNotification && (
            <div className="z-10 px-3 py-2 rounded-md bg-white border-l-[5px] flex items-center gap-2 border-green-600 fixed top-8 left-[50%] -translate-x-[50%]">
          ...
          <div
            ...
            className=" fixed bottom-10 w-16 h-16 max-sm:w-14 max-sm:h-14 cursor-pointer bg-white grid place-items-center rounded-full left-[90%] -translate-x-[50%] hover:bg-slate-300"
          >
